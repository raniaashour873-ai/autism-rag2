...
def get_refusal_message() -> str:
    return (
        "⚠️ هذا النظام غير مخصص للتعامل مع حالات الطوارئ أو تقديم نصيحة طبية "
        "فردية. إذا كنت تمر بحالة طارئة، يرجى التواصل فورًا مع خدمات الطوارئ "
        "المحلية أو أقرب مستشفى. هذا النظام مخصص فقط لتلخيص الإرشادات الطبية "
        "الرسمية العامة."
    )
